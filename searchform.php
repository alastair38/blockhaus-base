<form role="search" method="get" class="search-form flex gap-2" action="<?php echo home_url( '/' ); ?>">
	<label>
		...
		<input type="search" class="search-field shadow-retro px-4 py-1 border border-current focus-visible:outline-none focus-visible:ring-emerald-300 focus-visible:ring-4" placeholder="Search …" value="<?php echo get_search_query() ?>" name="s">
	</label>
