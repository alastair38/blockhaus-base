...
<div id="page-blockhaus" class="h-full flex flex-col">
    ...
    <svg class="w-12 h-12" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 500 500" width="500" height="500">
  <defs>
    <pattern id="pattern-1-0" patternTransform="matrix(5.791979, 0, 0, 5.791979, -39.598297, -39.59861)" xlink:href="#pattern-1"/>
    <pattern id="pattern-1" viewBox="0 0 900 900.0001" patternUnits="userSpaceOnUse" preserveAspectRatio="none" width="100" height="100">
      <g transform="matrix(1, 0, 0, 1, 128.00999450683594, 243.10800170898438)">
        <g>
          <rect x="-128.01" width="900" height="898.187" y="-243.108" style="fill: rgb(0, 20, 137);"/>
        </g>
  ...
  <ellipse style="fill: url(#pattern-1-0);" cx="250" cy="250" rx="244.393" ry="241.485"/>
</svg>
