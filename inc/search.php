...
function blockhaus_custom_form($placeholder = null, $post_type = null) {
	$form = '<form role="search" method="get" class="search-form w-fit text-sm leading-6 flex py-1 px-2 bg-primary rounded-full border border-neutral-light-100 focus-within:border-secondary gap-2" action="' . home_url( '/' ) . '">
	<label class="w-full">
	...
	<button type="submit" class="search-submit px-2 bg-offset text-primary rounded-full hover:bg-neutral-dark-500 transition-colors duration-200 cursor-pointer" aria-label="Submit search" value="Search">
		<svg class="fill-primary" aria-hidden="true" focusable="false" id="search-icon" class="search-icon" viewBox="0 0 24 24" width="24" height="24">
