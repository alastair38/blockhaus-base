...
function blockhaus_custom_form($placeholder) {
	$form = '<form role="search" method="get" class="search-form text-sm leading-6 flex py-1 px-2 bg-white rounded-full border border-gray-100 focus-within:border-emerald-300 gap-2" action="' . home_url( '/' ) . '">
	<label>
	...
	<button type="submit" class="search-submit px-2 bg-emerald-300 rounded-full hover:bg-emerald-200 transition-colors duration-200 cursor-pointer" aria-label="Submit search" value="Search">
